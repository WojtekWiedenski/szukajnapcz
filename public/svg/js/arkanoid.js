...
function ArkanoidGame(canvas, context) {
	...
	this.draw = function() {
		...
		if (this.gamePaused && !this.gameWin && !this.gameOver) {
			...
			context.fillText('Pauza', canvas.width / 2 - 30, canvas.height / 2);
		}

		if (this.gameOver) {
			context.fillStyle = 'rgb(255,255,0)';
			context.font = 'bold 20px Arial';
			context.fillText('Przegrałeś! Odśwież przeglądarkę', canvas.width / 2 - 40, canvas.height / 2);
		}

		if (this.gameWin) {
			context.fillStyle = 'rgb(255,255,0)';
			context.font = 'bold 20px Arial';
			context.fillText('Wygrałeś!', canvas.width / 2 - 40, canvas.height / 2);
		}

		context.fillStyle = 'rgb(255,255,220)';
		context.font = 'bold 15px Arial';
		context.fillText('Wynik: ' + this.score, 5, 15);

		context.fillStyle = 'rgb(255,255,220)';
		context.font = 'bold 15px Arial';
		context.fillText('Życia: ' + this.lifes, 5, 35);
	}
